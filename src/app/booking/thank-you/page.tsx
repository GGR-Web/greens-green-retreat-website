      ...
      <div className="container mx-auto px-4 md:px-6 py-16 md:py-24">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="mt-4 text-lg text-muted-foreground">
            We couldn&apos;t retrieve your booking details. Please contact us
        ...
        <Card className="shadow-xl">
          <CardHeader className="text-center">
            ...
            <CardDescription className="text-muted-foreground text-base">
              We&apos;ve got your inquiry and will respond via email within 24
              hours.
            </CardDescription>
          </CardHeader>
              ...
              <div className="border-2 border-accent/50 rounded-lg p-4 bg-accent/10">
                ...
                <div className="text-center my-4">
                  <p className="text-lg">
                    ...
                    <strong className="text-2xl font-mono text-primary">
                      625625
                    </strong>
                  </p>
                  <p className="text-lg">
                ...
                <p className="text-xs text-center text-muted-foreground mt-2">
                  Your booking is provisional and will be held for 24 hours
                  pending payment.
                </p>
              </div>
            </div>
